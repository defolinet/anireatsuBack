    ...
    res.send({
        ...
        animes: [
            ...
            },
            {
                ...
                url: "/anime/Thisstupidpigdoesnotunderstandthedreamofabunnygirl"
            }
...
app.get("/anime/magicbattle",(reg,res) =>{
    res.send({
        name: "Магическая битва",
        release: {
            day: 2,
...
app.get("/anima/attackontitans", (reg, res) =>{
    res.send({
       name: "Атака на титанов", 
       release: {
        day: 7,
...
app.get("/anime/yourname",(reg, res) =>{
    res.send({
        name: "Твоё имя",
        release: {
        day: 26,
...
app.get("/anime/tokyoavengers", (reg,res)=>{
    res.send({
        name: "Токийские мстители",
        release: {
       day: 11,
...
app.get("/anime/ChainsawMan", (reg, res) =>{
    res.send({
        name: "Человек-бензопила",
        release: {
       day: 12,
...
app.get("/anime/onepiece", (reg, res)=>{
    res.send({
        name: "Ван-Пис",
        release: {
            day: 20,
...
app.get("/anime/volleyball", (reg, res) =>{
    res.send({
        name: "Волейбол",
        release: {
            day: 8,
...
app.get("/anime/Thisstupidpigdoesnotunderstandthedreamofabunnygirl", (reg,res) =>{
    res.send({
        name: "Этот глупый свин не понимает мечту девочки-зайки",
        release:{
            day:3,
...
app.get("/genres/fantasy", (reg, res) => {
    res.send({
        name: "фэнтези"
    })
...
app.get("/genres/demons", (reg,res) => {
    res.send({
        name:'демоны'
    })
})

app.get("/genres/school", (reg, res) => {
    res.send({
        name: "школа"
    })
...
app.get("/genres/romance", (reg, res) => {
    res.send({
        name: "романтика"
    })
