...
const animesSeven = [
    ...
    },
    {
        ...
        images:{
            card: getCard('bookworm_power'),
            banner: getBanner('bookworm_power'),
            minor: getMinor('bookworm_power')
        },  
        rating: 8.8,
        restriction: 16,
    },
    {
        ...
        images:{
            card: getCard('history_memories'),
            banner: getBanner('history_memories'),
            minor: getMinor('history_memories')
        },
        rating: 7.9,
        restriction: 16,
    },
    ...
    },
    {
        ...
        images:{
            card: getCard('emptiness_horison'),
            banner: getBanner('emptiness_horison'),
            minor: getMinor('emptiness_horison')
        },
        rating: 6.8,
        restriction: 16
    },
    ...
    },
    {
        ...
        images:{
            card: getCard('ikebukuro_park'),
            banner: getBanner('ikebukuro_park'),
            minor: getMinor('ikebukuro_park')
        },
        rating: 6.8,
        restriction: 16
    },
